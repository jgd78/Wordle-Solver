...
def calculateword():
    ...
    canvas1.create_window(5*boxsize, 3*boxsize, width=10*boxsize, height=.5*boxsize, window=labelnext)   
...
root=Tk()
boxsize=50
canvas1=Canvas(root, width = 10*boxsize, height=4*boxsize, bg='blue')
canvas1.pack()
labelword=Label(root, text="Your guess:")
labelreset=Label(root, text="Reset game")
...
canvas1.create_window(5*boxsize, 1*boxsize, width=2*boxsize, height=.5*boxsize, window=labelcolors)
canvas1.create_window(5*boxsize, 2*boxsize, width=2*boxsize, height=.5*boxsize, window=entrycolors)

buttonenter=Button(text="Enter", command=calculateword)
canvas1.create_window(8*boxsize, 1*boxsize, width=2*boxsize, height=.5*boxsize, window=buttonenter)
buttonreset=Button(text="Reset game", command=reset)
canvas1.create_window(8*boxsize, 2*boxsize, width=2*boxsize, height=.5*boxsize, window=buttonreset)
